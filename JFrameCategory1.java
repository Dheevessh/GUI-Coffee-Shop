...
public class JFrameCategory1 extends JFrame implements ActionListener
{
  ...
  double priceF1 = 14.50;
  JLabel nameF1 = new JLabel("Caramel   RM " + priceF1);
  
  JButton Frape2 = new JButton(new ImageIcon("Frape2.jpg"));
  double priceF2 = 16.50;
  JLabel nameF2 = new JLabel("Mocha   RM " + priceF2);
  
  JButton Frape3 = new JButton(new ImageIcon("Frape3.jpg"));
  double priceF3 = 18.50;
  JLabel nameF3 = new JLabel("Cookies and Cream  RM " + priceF3);
  
  JButton Frape4 = new JButton(new ImageIcon("Frape4.jpg"));
  double priceF4 = 21.50;
  JLabel nameF4 = new JLabel("Chocolate   RM " + priceF4);
  ...
  //menu bars
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      {
        JFrameCategory1Drink1 firstDrink = new JFrameCategory1Drink1();
      ...
      {
      JFrameCategory1Drink2 firstDrink = new JFrameCategory1Drink2();
      firstDrink.setVisible(true);
      this.dispose();
      }
      //3
      ...
      {
      JFrameCategory1Drink3 firstDrink = new JFrameCategory1Drink3();
      firstDrink.setVisible(true);
      this.dispose();
      }
      //4
      ...
      {
      JFrameCategory1Drink4 firstDrink = new JFrameCategory1Drink4();
      firstDrink.setVisible(true);
      this.dispose();
      }
    }
  ...
  {
    JFrameCategory1 frame2 = new JFrameCategory1();
