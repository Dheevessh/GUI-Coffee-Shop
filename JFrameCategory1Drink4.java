...
public class JFrameCategory1Drink4 extends JFrame implements ActionListener
{
 //Drink1
  JFrame Drink4 = new JFrame("Drink4");
  JLabel Drinkf4 = new JLabel(new ImageIcon("Frape4.jpg"));
  JCheckBoxMenuItem sugar = new JCheckBoxMenuItem("MORE SUGAR");
  JCheckBoxMenuItem cream = new JCheckBoxMenuItem("MORE CREAM");
  JButton Next = new JButton("Next");
  

    public JFrameCategory1Drink4()
  {
  ...
  //Drink1
    ...
    Drink4.setContentPane(backgroundLabel11);
    
    Drink4.setSize(600,550);
    Drink4.setVisible(true);
    Drink4.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    this.dispose();
    
    //drink1 image
    setLayout(null);
    Drinkf4.setBounds(50, 150, 500, 400);
    Drink4.add(Drinkf4);
