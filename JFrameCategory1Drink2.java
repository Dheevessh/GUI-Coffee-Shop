...
public class JFrameCategory1Drink2 extends JFrame implements ActionListener
{
   //Drink2
  JFrame Drink2 = new JFrame("Drink2");
  JLabel Drinkf2 = new JLabel(new ImageIcon("Frape2.jpg"));
  JCheckBoxMenuItem sugar = new JCheckBoxMenuItem("MORE SUGAR");
  JCheckBoxMenuItem cream = new JCheckBoxMenuItem("MORE CREAM");
  JButton Next = new JButton("Next");
  

    public JFrameCategory1Drink2()
  {
      
  //Drink2
    ImageIcon backgroundImage12 = new ImageIcon(getClass().getResource("Background images.jpg"));
    JLabel backgroundLabel12 = new JLabel(backgroundImage12);
    Drink2.setContentPane(backgroundLabel12);
    
    Drink2.setSize(600,550);
    Drink2.setVisible(true);
    Drink2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

    //drink2 image
    setLayout(null);
    Drinkf2.setBounds(50, 150, 500, 400);
    Drink2.add(Drinkf2);
...
//Layout
  ...
  {
    JFrameCategory1Drink2 frame2 = new JFrameCategory1Drink2();
