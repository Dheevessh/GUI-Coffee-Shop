...
public class JFrameCategory2Iced4 extends JFrame implements ActionListener
{
 //Drink1
  JFrame Drink1 = new JFrame("Drink1");
  JLabel Drinkf1 = new JLabel(new ImageIcon("iced4.jpg"));
  JCheckBoxMenuItem sugar = new JCheckBoxMenuItem("MORE SUGAR");
  JCheckBoxMenuItem cream = new JCheckBoxMenuItem("MORE CREAM");
  JButton Next = new JButton("Next");
  

    public JFrameCategory2Iced4()
  {
  ...
  {
    JFrameCategory2Iced4 frame2 = new JFrameCategory2Iced4();
