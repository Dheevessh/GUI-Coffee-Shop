...
public class JFrameCategory3 extends JFrame implements ActionListener
{
  //Category 1 drinks frame
  JFrame cat1Frame = new JFrame("cat1");
  
  JLabel typeDrink = new JLabel("Choose your Type of Drink:");
  
  JButton Frape1 = new JButton(new ImageIcon("hot1.jpg"));
  double priceF1 = 17.90;
  JLabel nameF1 = new JLabel("Hot Caffe Latte   RM " + priceF1);
  
  JButton Frape2 = new JButton(new ImageIcon("hot2.jpg"));
  double priceF2 = 21.90;
  JLabel nameF2 = new JLabel("Hot Chocolate   RM " + priceF2);
  
  JButton Frape3 = new JButton(new ImageIcon("hot3.jpg"));
  double priceF3 = 15.90;
  JLabel nameF3 = new JLabel("Hot Cappucino  RM " + priceF3);
  
  JButton Frape4 = new JButton(new ImageIcon("hot4.jpg"));
  double priceF4 = 23.90;
  JLabel nameF4 = new JLabel("Hot Espresso   RM " + priceF4);
  
  
  
  public JFrameCategory3()
  {
  //Category1 Frame
   ...
   //for Frape4
    setLayout(null);
    Frape4.setBounds(1150, 530, 500, 320);
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      {
      JFrameCategory3Hot1 firstDrink = new JFrameCategory3Hot1();
      ...
      {
      JFrameCategory3Hot2 firstDrink = new JFrameCategory3Hot2();
      firstDrink.setVisible(true);
      this.dispose();
      }
      //3
      ...
      {
      JFrameCategory3Hot3 firstDrink = new JFrameCategory3Hot3();
      firstDrink.setVisible(true);
      this.dispose();
      }
      //4
      ...
      {
      JFrameCategory3Hot4 firstDrink = new JFrameCategory3Hot4();
      firstDrink.setVisible(true);
      this.dispose();
      }
    }
  ...
  {
    JFrameCategory3 frame2 = new JFrameCategory3();
