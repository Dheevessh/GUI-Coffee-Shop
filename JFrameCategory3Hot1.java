...
public class JFrameCategory3Hot1 extends JFrame implements ActionListener
{
 //Drink1
  JFrame Drink1 = new JFrame("Drink1");
  JLabel Drinkf1 = new JLabel(new ImageIcon("hot1.jpg"));
  ...
  {
    JFrameCategory3Hot1 frame2 = new JFrameCategory3Hot1();
