...
public class JFrameCategory2Iced2 extends JFrame implements ActionListener
{
 //Drink1
  JFrame Drink1 = new JFrame("Drink2");
  JLabel Drinkf1 = new JLabel(new ImageIcon("iced2.jpg"));
  JCheckBoxMenuItem sugar = new JCheckBoxMenuItem("MORE SUGAR");
  JCheckBoxMenuItem cream = new JCheckBoxMenuItem("MORE CREAM");
  JButton Next = new JButton("Next");
  

    public JFrameCategory2Iced2()
  {
  ...
  //Drink1
    ...
    public void actionPerformed(ActionEvent e)
    {
      ...
      if (e.getSource() == Next)
      {
        ...
        setLayout(null);
        sugar1.setBounds(800, 450, 700, 70);
  ...
  {
    JFrameCategory2Iced2 frame2 = new JFrameCategory2Iced2();
