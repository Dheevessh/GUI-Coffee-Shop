...
public class JFrameCategory1Drink3 extends JFrame implements ActionListener
{
 //Drink1
  JFrame Drink3 = new JFrame("Drink3");
  JLabel Drinkf3 = new JLabel(new ImageIcon("Frape3.jpg"));
  JCheckBoxMenuItem sugar = new JCheckBoxMenuItem("MORE SUGAR");
  JCheckBoxMenuItem cream = new JCheckBoxMenuItem("MORE CREAM");
  JButton Next = new JButton("Next");
  

    public JFrameCategory1Drink3()
  {
  ...
  //Drink1
    ...
    Drink3.setContentPane(backgroundLabel11);
    
    Drink3.setSize(600,550);
    Drink3.setVisible(true);
    Drink3.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    this.dispose();
    
    //drink1 image
    setLayout(null);
    Drinkf3.setBounds(50, 150, 500, 400);
    Drink3.add(Drinkf3);
  ...
  {
    JFrameCategory1Drink1 frame2 = new JFrameCategory1Drink1();
